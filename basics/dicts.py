"~~~~~~~~~~~~~~~~~~~~~~~~СЛОВАРИ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
#ditc - изменяемый тип данных,итерируемый, некупорядоченный, неиндексируемый тип данных,
...
#ключи в словаре будут уникальными поэтому если в словарь добавить значение по уже сущ ключу
#то сохранится последнее значение
...
# #В словаре users в качестве ключей используются числа, 
# # а в качестве значений - строки. В словаре element в качестве ключей используются строки.
# #Но необязательно ключи и строки должны быть однотипными. Они могут представлять разные типы:
# #  objects = {1: "Tom", "2": True, 3: 100.6} 
# # Мы можем также вообще определить пустой словарь без элементов:objects = {} или так: objects = dict()