"~~~~~~~~~~~~~~~~~~~~~`ЦИКЛЫ`~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
#циклы это действия которое повторяется,блок кода которая отрабатывается несколько раз. Python есть два цикла:
#for - цикл который работает с итерируемые обьектами, цикл заканчивает свою работу когда он доходит до последнего элемента
