...
class BaseParser:
    ...
    def search(self, query:str)-> List[dict]:
        "принимает в себя поисковое слово и возврашает список со всеми результатами"
    ...
    def _get_products_list(self, soup: BS) -> List[BS]:
        "метод в котором ищется все блоки с продуктами"
        raise NotImplemented
    
    def _get_product_info(self, soup: BS) -> dict:
        "метод в котором ишется title, price продукта"
        raise NotImplemented
