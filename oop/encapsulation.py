...
#         self.__email = value 
# john = Person() 
# print(john.name) None print(john.last_name) # None print(john.age) # None print(john.email) # None john.name = 'John' john.last_name = 'Snow' john.age = 30 john.email = 'johnsnow@gmail.com' print(john.name) 
# John print(john.last_name) # Snow print(john.age) # 30 print(john.email) # johnsnow@gmail.com
...
class Me(Dad): 
    ...
    __age = 40 
    def about_me(self): 
        print(f"My name is {self.name} {self._last_name} and I am {self._Dad__age} years old") 
